                            ...
                            @foreach($paginatedData as $entry)
                                <tr>
                                    ...
                                    <td class="text-center">
                                        <a href="{{ route('admin.enquires.show', $entry->id) }}" class="btn btn-sm btn-primary">View</a>
                                        <a data-id="{{ $entry->id }}" href="{{ route('admin.enquires.delete', $entry->id) }}" class="btn btn-sm btn-danger delete-btn">Delete</a>
                                          {{-- Hidden Form (Laravel delete) --}}
                                        <form id="delete-form-{{ $entry->id }}" 
                                            action="{{ route('admin.enquires.delete', $entry->id) }}" 
